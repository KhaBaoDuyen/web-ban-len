    ...
    return (
        <div className=" min-h-screen pb-10">
            ...
            <div className="bg-white  ">
                <div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-2 text-sm text-primary-600 overflow-x-auto whitespace-nowrap">
                    <Link href="/" className="hover:text-primary-600 transition">Trang chủ</Link>
                    <FiChevronRight size={14} />
                    <Link href="/san-pham" className="hover:text-primary-600 transition">Sản phẩm</Link>
                    <FiChevronRight size={14} />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-7 space-y-6">
                        <div className="bg-white lg:p-6 p-3 rounded-2xl shadow-sm border border-slate-100">
                            <span className="inline-block px-3 py-1 rounded-full text-[10px] font-bold mb-3 bg-primary-100 text-primary-600 uppercase tracking-widest">
                            ...
                            <div className="bg-primary-50 lg:p-5 p-3 rounded-xl border border-slate-200 space-y-4 mb-6">
                                <h3 className="font-bold text-slate-800 flex items-center gap-2">
                                    <FiShoppingCart className="text-primary-600" /> Thông tin đặt hàng
                                </h3>
                                    ...
                                    <div className="space-y-1">
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`w-full pl-10 pr-4 py-2.5 rounded-lg border bg-white outline-none transition ${errors.name ? 'border-red-500' : 'border-slate-200 focus:border-primary-600'}`}
                                    ...
                                    <div className="space-y-1">
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                ${errors.phone ? 'border-red-500' : 'border-slate-200 focus:border-primary-600'}`}
    ...
    `}
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-4">
                                <div className="flex items-center bg-slate-100 p-1 rounded-xl w-full sm:w-fit justify-between">
                                    <button onClick={() => setQuantity(q => Math.max(1, q - 1))} className="w-10 h-10 flex items-center justify-center bg-white rounded-lg shadow-sm hover:text-primary-600 transition"><FiMinus /></button>
                                    <span className="px-8 font-black text-slate-800">{quantity}</span>
                                    <button onClick={() => setQuantity(q => q + 1)} className="w-10 h-10 flex items-center justify-center bg-white rounded-lg shadow-sm hover:text-primary-600 transition"><FiPlus /></button>
                                </div>
                                <button
                                    onClick={() => setOpenConfirm(true)}
                                    className="w-full flex-1 h-14 bg-primary-600 text-white font-bold py-3 lg:py-2 rounded-xl hover:bg-primary-600 transition shadow-lg uppercase tracking-widest text-sm"
                                >
                                    Đặt hàng ngay
                                </button>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="flex items-center gap-3 p-4 bg-white rounded-xl border border-slate-100 shadow-sm">
                                <div className="text-primary-600 bg-primary-50 p-2 rounded-lg"><FiTruck size={20} /></div>
                                <span className="text-xs font-bold text-slate-600 uppercase">Giao toàn quốc</span>
                            </div>
                            <div className="flex items-center gap-3 p-4 bg-white rounded-xl border border-slate-100 shadow-sm">
                                <div className="text-primary-600 bg-primary-50 p-2 rounded-lg"><FiShield size={20} /></div>
                                <span className="text-xs font-bold text-slate-600 uppercase">Chính hãng</span>
                            </div>
                            <div className="flex items-center gap-3 p-4 bg-white rounded-xl border border-slate-100 shadow-sm">
                                <div className="text-primary-600 bg-primary-50 p-2 rounded-lg"><FiRefreshCw size={20} /></div>
                ...
                <div className="mt-8 space-y-6">
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                        ...
                        <button
                            ...
                            className="mt-4 mx-auto flex items-center gap-2 text-primary-600 font-bold hover:underline transition"
                        >
                    ...
                    <div className="bg-primary-50 p-6 rounded-2xl border border-primary-100">
                        <h2 className="text-primary-800 font-black mb-3 text-sm uppercase tracking-widest flex items-center gap-2">
                        ...
                        <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3">
                            {[
                                ...
                                <li key={i} className="flex items-start gap-2 text-[13px] text-primary-700 font-medium">
                                    <div className="mt-1 flex-shrink-0">
                                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="text-primary-500">
                        ...
                        <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl p-6 animate-in fade-in zoom-in">
                            ...
                            <div className="flex gap-3 mt-6">
                                ...
                                <button
                                    ...
                                    className="flex-1 py-2.5 rounded-xl bg-primary-600 hover:bg-primary-600 text-white font-bold shadow"
                                >
                                    Xác nhận đặt hàng
                                </button>
                            </div>
